...
export const GLOSSARY: Record<string, {label?: string; help: string}> = {
  ...
  'SHARP_CONFIRMED': {help: 'Both OddsCrowd and Fadereport show sharp money on this side. Two independent sources agreeing.'},
  'SHARP_TRIPLE_CONFIRMED': {help: 'All three public-split sources (OC + FR + Cleatz) agree on the sharp side. Highest confidence tier.'},
