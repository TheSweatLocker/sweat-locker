...
def build_row(event: dict, aliases: dict, team_stats: dict, stats_source: str = 'current',
    ...
    # 2026-09-13 canonical season_week (final anchor): Sweat Shop 2026
    # season NFL Week 1 = 9/9-9/15 inclusive (Andy authority). Anchor is
    # 2026-09-09 (Tue). Prior attempts 9/4 (real-world) and 9/11 (Thu of
    # W1) both wrong. See feedback_nfl_2026_week1_anchor + migration
    # 20260913h for the definitive anchor.
    def _season_week(_dt, _season):
        ...
        wk1_start = __date(2026, 9, 9)
        delta = (_dt.date() - wk1_start).days
        if delta < 0: return 0
        return delta // 7 + 1
