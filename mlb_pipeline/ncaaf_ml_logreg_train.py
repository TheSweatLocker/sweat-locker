"""NCAAF ML logistic regression trainer. Same pattern as NFL/MLB.
Trained on ncaaf_game_results — ~1000 games from 2022 season."""
...
def train(dry_run: bool = False):
    ...
    print(f'  {len(rows)} resolved NCAAF games')
    if len(rows) < 200:
    ...
    out_path = MODELS_DIR / 'ncaaf_ml_logreg.json'
